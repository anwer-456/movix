...
*/
// PsyPlay child
function psyplay_child_theme_scripts_n_styles() {
	wp_register_style( 'psythemes', get_stylesheet_uri(), '', DT_VERSION);
	wp_enqueue_style( 'psythemes', get_template_directory_uri().'/style.css' );
}
add_action('wp_enqueue_scripts', 'psyplay_child_theme_scripts_n_styles', 99);
